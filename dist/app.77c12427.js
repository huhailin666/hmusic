...
},{}],"src/js/player.js":[function(require,module,exports) {
  ...
  _createClass(Player, [{
    ...
    value: function bind() {
      ...
      $('#list').on('click', '.icon-delete', function () {
        ...
        _this.renderList(); // $('#app').removeClass('active')
      ...
      this.$('.header .return').onclick = function () {
    ...
    key: "loadMusic",
    value: function loadMusic(callback) {
      var _this = this;

      $.getJSON('https://jirenguapi.applinzi.com/fm/getSong.php?public_tuijian_ktv', {
    ...
    value: function loadLyric() {
      ...
      $.getJSON('https://jirenguapi.applinzi.com/fm/getLyric.php', {
        ...
        lyric.split(/\n/g).forEach(function (xxx) {
          var c = xxx.replace(/\[.+\]/g, '');
          var b = c.replace(/音乐来自百度FM, by 饥人谷/, '');
          ...
          if (b === '') {
            ...
            if (a) {
              var ms = a[0] * 60000 + a[1] * 1000 + a[2].slice(0, 2) * 10;
              lyricsObj.push([ms, b]);
            }
          }
        });
        _this3.lyricsArr = lyricsObj;
    ...
    value: function renderLyrics() {
      ...
      this.lyricsArr.forEach(function (xxx) {
    ...
    value: function setLineToCenter(node) {
      ...
      this.$('.panel-lyrics .lyrics-contain').style.transform = "translateY(-".concat(translateY, "px)");
    ...
    value: function locateLyric() {
      ...
      if (currentTime > nextLineTime && this.lyricIndex < this.lyricsArr.length - 1) {
        this.lyricIndex++;
        var node = this.$$('.panel-lyrics .lyrics-contain p')[this.lyricIndex];
...
},{}],"src/js/control.js":[function(require,module,exports) {
"use strict";
  ...
  _createClass(control, [{
    ...
    value: function bind() {
      ...
      $('#list').on('click', 'h5', function () {
        ...
        // $('#player').addClass('active');
        EventCenter.fire('play-song', {
          song: p.musicList[$(this).parent().index()]
        });
      }); //点击音乐分类
      ...
      $('.main .dayChoose >ul').on('click', 'li', function () {
        ...
        $('#player').addClass('active');
        EventCenter.fire('play-song', {
          song: app.dayChooseList[$(this).index()]
        });
      }); //点击切换
      ...
      $('.main .recommend >ul').on('click', 'li', function () {
        ...
        EventCenter.fire('play-song', {
          song: app.recommendList[$(this).index()]
        });
      }); //点击加载更多音乐分类
...
new control();
},{"./player.js":"src/js/player.js"}],"node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./..\\svg\\effect-no-move.svg":[["effect-no-move.e6a51026.svg","src/svg/effect-no-move.svg"],"src/svg/effect-no-move.svg"],"./..\\svg\\effect-move1.svg":[["effect-move1.8d0ce205.svg","src/svg/effect-move1.svg"],"src/svg/effect-move1.svg"],"./..\\svg\\effect-move2.svg":[["effect-move2.143040a0.svg","src/svg/effect-move2.svg"],"src/svg/effect-move2.svg"],"./..\\svg\\progress.svg":[["progress.798a5c76.svg","src/svg/progress.svg"],"src/svg/progress.svg"],"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"src/js/app.js":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(app, [{
    ...
    value: function start() {
      ...
      $.getJSON('https://jirenguapi.applinzi.com/fm/getChannels.php').done(function (xxx) {
    ...
    key: "renderHotList",
    value: function renderHotList(ccc) {
      var xxx = ccc.channels;
      var tpl = '';
    ...
    value: function load() {
      ...
      for (var i = 0; i < 8; i++) {
        $.getJSON('https://jirenguapi.applinzi.com/fm/getSong.php', {
          channel: _this.channelsList[_this.channelIndex + 3]
        }).done(function (xxx) {
          var x = xxx.song[0];

          _this.dayChooseList.push(x);

          var node = "<li>\n                                <img src= \"".concat(x.picture, "\">\n                                <svg class=\"play\"  aria-hidden=\"true\">\n                                    <use xlink:href=\"#icon-play\"/>\n                                </svg>\n                                <h5>").concat(x.title, "</h5>\n                                <svg class=\"sq\" aria-hidden=\"true\">\n                                    <use xlink:href=\"#icon-sq\"></use>\n                                </svg>\n                                <p>").concat(x.artist, "</p>\n                            </li>");
    ...
    key: "recommendMusic",
    value: function recommendMusic() {
      var _this = this;

      for (var i = 0; i < 8; i++) {
        $.getJSON('https://jirenguapi.applinzi.com/fm/getSong.php', {
          channel: _this.channelsList[_this.channelIndex + 20]
        }).done(function (xxx) {
          var x = xxx.song[0];
...
window.app = new app();
},{"./icons.js":"src/js/icons.js","./control.js":"src/js/control.js","../scss/app.scss":"src/scss/app.scss","../scss/index.scss":"src/scss/index.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
